...
export class InitialMigration1631833983843 implements MigrationInterface {
  name = 'InitialMigration1631833983843';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "order" ("order_id" BIGSERIAL NOT NULL, "created_at" TIMESTAMP(3) NOT NULL DEFAULT now(), "total_price" numeric(11,2) NOT NULL DEFAULT '0.00', "inputs_price" numeric(11,2) NOT NULL DEFAULT '0.00', "is_avaible" boolean NOT NULL, "user_id" bigint NOT NULL, CONSTRAINT "PK_58998c5eaeaacdd004dec8b5d86" PRIMARY KEY ("order_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "order_product_order" ADD CONSTRAINT "FK_55541f850a81381847cb5665b07" FOREIGN KEY ("order_id") REFERENCES "order"("order_id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "order_product_order" ADD CONSTRAINT "FK_d0d3ef52c637e9d9b404a3bb12d" FOREIGN KEY ("product_id") REFERENCES "product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
